...
public class MainRestController {
    ...
    // 어떤 이메일(key)에 대해 생성된 인증번호(value)를 저장하는 저장소(repository)
    ...
    public ResponseEntity<Void> get_email_auth(
        ...
        // 해당 이메일로 인증받은 적이 없다면, 혹은 사용자가 입력한 인증번호와 저장된 인증번호가 다르다면
